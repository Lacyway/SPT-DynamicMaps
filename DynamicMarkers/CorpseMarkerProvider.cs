...
namespace DynamicMaps.DynamicMarkers
{
	public class CorpseMarkerProvider : IDynamicMarkerProvider
	{
		...
		public void OnMapChanged(MapView map, MapDef mapDef)
		{
			...
			foreach (Player corpse in _corpseMarkers.Keys.ToList())
			{
		...
		private void TryAddMarker(Player player)
		{
			...
			string category = _otherCorpseCategory;
			string imagePath = _otherCorpseImagePath;
			Color color = _otherCorpseColor;
			...
			// try adding marker
			MapMarker marker = _lastMapView.AddMapMarker(markerDef);
		...
		private void RemoveDisabledMarkers()
		{
			foreach (Player corpse in _corpseMarkers.Keys.ToList())
			{
				MapMarker marker = _corpseMarkers[corpse];
